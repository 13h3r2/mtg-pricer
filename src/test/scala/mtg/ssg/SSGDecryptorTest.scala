...
//        |.xyYGBu2 {background-position:-28px 21px;}
//      """.stripMargin
//    val decryptor = new SSGDecryptor(secret, "987654321.0")
//    assert(decryptor.decrypt(".njjnGl") == "8")
//  }
}
